      ...
      >
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className=" ">
              Trusted Quality & Innovation in Animal Nutrition
            </span>
            <br />
            <h2 className="sub-title fs-1 mt-3">About Nordic BioGains</h2>
          </div>
          <div className="outer-box">
            <div className="row justify-content-center">
              <Slider {...settings}>
                ...
                <div className="service-block-three col wow fadeInUp ">
                  <div className="inner-box">
                    <img src={product} className="icon p-10 " alt="" />
                    <h6 className="title">
                      <Link>MAXIGAIN VM</Link>
                    </h6>
                ...
                <div className="service-block-three col wow fadeInUp ">
                  <div className="inner-box">
                    ...
                    <MdProductionQuantityLimits className="icon p-10 " />
                    ...
                    <div className="text">
                      Advanced Trace Mineral Supplement
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box ">
                    ...
                    <div className="text">
                      {" "}
                      Support for Dairy Cattle Transition
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box ">
                    ...
                    <div className="text">
                      High-Potency Vitamin E for Livestock.
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box ">
                    ...
                    <h6 className="title">
                      <Link>
                        NORDIC <br /> VITALYEAST
                      </Link>
                    </h6>
                    <div className="text">
                      Boosting Rumen Health & Digestion
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box">
                    ...
                    <div className="text">
                      Dietary Cation-Anion different (DCAD) for transition
                      period{" "}
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box">
                    ...
                    <MdProductionQuantityLimits className="icon p-10 " />
                    <h6 className="title">
                      <Link>NORDIPHYTASE</Link>
                    </h6>
                    <div className="text">
                      Boost Phosphorus Utilization, Cut Feed Costs
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="inner-box">
                    ...
                    <h6 className="title">
                      <Link>
                        PROMETH <br /> NORDIC RP{" "}
                      </Link>
                    </h6>
                    <div className="text">
                      Rumen-Protected Methionine for Ruminants
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="inner-box">
                    ...
                    <div className="text">
                      High-Performance Nutrition for Dairy Cattle
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box">
                    ...
                    <div className="text">
                      Sweetner to enhace taste and smell of feed{" "}
                    </div>
                  </div>
                </div>
              </Slider>
